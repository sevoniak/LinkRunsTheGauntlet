...
void QuadTexturedModel::setTextureName(WCHAR* fileName)
{
...
void QuadTexturedModel::changeUV(float nu, float nv, float du, float dv)
{
	m_textureVertices[0].texture = XMFLOAT2(nu, nv+dv);
	m_textureVertices[1].texture = XMFLOAT2(nu, nv);
	m_textureVertices[2].texture = XMFLOAT2(nu+du, nv+dv);
	m_textureVertices[3].texture = XMFLOAT2(nu+du, nv);
}
